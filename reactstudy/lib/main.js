		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(CommentForm, { onSubmit: function onSubmit(comment) {
						return _this5.handleNewComment(comment);
					} })
			);
		}
	}]);
...
var box = ReactDOM.render(React.createElement(CommentBox, { url: "serverload.json" }), document.getElementById('example'));